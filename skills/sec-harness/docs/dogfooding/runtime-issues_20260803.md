...
| 011 | Prefilter (clsmap/demote) | ai-platform | correctness (recall) | high-sev CodeQL resource/DoS rules → cls `unknown` → demote_noise silently drops to informational | FIXED (79a745b): CWE-400/770/834 + rule-ids route to `resource` class |
